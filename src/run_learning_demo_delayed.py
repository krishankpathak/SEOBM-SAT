# src/run_learning_demo_delayed.py
# ======================================
# Learning demo with delayed prediction
# ======================================
...
from src.tasks.delayed_prediction import delayed_target
...
# -------- Delayed task --------
x_feat, y = delayed_target(features, DELAY)
x_seobm = seobm[:-DELAY].transpose(0, 2, 1)
...
print("✅ Delayed prediction demo complete.")
